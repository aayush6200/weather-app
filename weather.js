const ondataSubmit = (event) => {
  ...
  let myWeatherData = [];  // Weather data for the current hour
  let myDataForDay = [];  // Weather data for a day
  let myDataForDays = [];  // Weather data for the next four days
  ...
  const myWeather = async () => {
    ...
    let myObj = {
      visible: response.visibility,  // Visibility data for a particular time of day
